...
class OTAManager:
    ...
    async def _download_atomic(self, url: str, dest_path: str):
    ...
    async def update_lib(self, filepaths: list):
        success = True
        for filepath in filepaths:
            ...
            if not (await self._download_atomic(file_url, UPDATABLE_MODULES_DIR + filepath)):
                success = False
